...
function $set<T extends Map<string, any>>(
  source: T, key: Parameters<T['set']>[0], value: Parameters<T['set']>[1]
): T
function $set<T extends Record<string, any>>(
  source: T, key: keyof T, value: T[keyof T]
): T
function $set<T extends Assoc<string, any>>(
  source: T,
  key: T extends Map<string, any> ? Parameters<T['set']>[0] : keyof T,
  value: T extends Map<string, any> ? Parameters<T['set']>[1] : T[keyof T]
): T
